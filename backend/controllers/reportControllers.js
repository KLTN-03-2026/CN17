...
// @desc    Xuất báo cáo công việc dưới dạng Excel
...
const exportTasksReport = async (req, res) => {
    try {
        ...
        return workbook.xlsx.write(res).then(() => { // ← sửa ngoặc
            res.end();
        });
...
// @desc    Xuất báo cáo người dùng dưới dạng Excel
...
const exportUsersReport = async (req, res) => {
    try {
        ...
        worksheet.columns = [   // ← array, không phải object
