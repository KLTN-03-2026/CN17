 ...
 const updateTask = async () => {
  ...
  const handleSubmit = async () => {
    ...
    if (taskData.assignedTo?.length === 0) {
      setError("Task not assigned to any member. Please assign to at least one member.");
      return;
    }
    if (taskData.todoChecklist?.length === 0) {
      setError("TODO Checklist is empty. Please add at least one item to the checklist.");
      return;
    }
    if (taskID) {
      updateTask();
  ...
  const deleteTask = async () => {
    try {
      ...
      console.error("có lỗi khi xóa task" , 
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 mt-4">
          <div className="form-card col-span-3">
            ...
            <div className="mt-4">
              ...
              <input
                placeholder="Nhập tiêu đề của Task"
