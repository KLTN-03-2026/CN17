...
const STATUS_STYLES = {
    active: {
        class: "text-lime-600 bg-lime-50 border border-lime-200",
        label: "Đang hoạt động",
    },
    completed: {
        class: "text-blue-600 bg-blue-50 border border-blue-200",
        label: "Đã hoàn thành",
    },
    archived: {
        class: "text-gray-500 bg-gray-50 border border-gray-200",
        label: "Đã lưu trữ",
    },
};
...
const ManageProject = () => {
    ...
    const handleOpenNotificationModal = (projectId) => {
    ...
    const handleDelete = async (projectId) => {
        if (
            !window.confirm(
                "Hành động này không thể hoàn tác. Bạn chắc chắn muốn xóa dự án này?"
            )
        ) {
            return;
        }
            ...
            <div className="mt-5">
                <div className="flex items-center justify-between mb-6">
                    ...
                    <button
                        ...
                        onClick={() =>
                            navigate("/leader/projects/create")
                        }
                    >
                ...
                {loading ? (
                    ...
                    <div className="card text-center py-16 bg-gray-50/50 border-dashed border-2 border-gray-200">
                        ...
                        <p className="text-xs text-gray-400 mt-1">
                            Hãy bắt đầu bằng cách tạo một dự án mới để quản lý công việc.
                        </p>
                        ...
                        {projects.map((project) => (
                            ...
                            >
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <button
                                        className="btn-secondary flex items-center gap-1.5 justify-center text-xs py-2 hover:bg-primary hover:text-white hover:border-primary transition-all"
                                        onClick={() =>
                                            navigate(
                                                `/leader/projects/${project._id}/tasks`
                                            )
                                        }
                                    >
                                    ...
                                    <button
                                        className="btn-secondary flex items-center gap-1.5 justify-center text-xs py-2 hover:bg-amber-500 hover:text-white hover:border-amber-500 transition-all"
                                        onClick={() =>
                                            navigate(
                                                `/leader/projects/${project._id}/invite`
                                            )
                                        }
                                    >
                                        <LuUsers className="text-sm" />
                                    ...
                                    <button
                                        className="btn-secondary flex items-center gap-1.5 justify-center text-xs py-2 hover:bg-purple-500 hover:text-white hover:border-purple-500 transition-all"
                                        onClick={() =>
                                    ...
                                    <button
                                        className="flex items-center gap-1.5 justify-center text-xs py-2 text-gray-500 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all border border-gray-100 hover:border-red-100"
                                        title="Xóa dự án"
                                        onClick={() =>
