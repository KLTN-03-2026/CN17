...
const DashBoard = () => {
  ...
  const prepareChartData = (data) => {
    console.log("API charts data:", data);
    const taskDistributionData = data?.taskDistribution || {}; 
    const taskPriorityLevels = data?.priorityDistribution || {};
  ...
  const getDashboardData = async () => {
    try {
      const response = await axiosInstance.get(API_PATHS.TASKS.GET_REPORTS_DATA);
      if (response.data) {
